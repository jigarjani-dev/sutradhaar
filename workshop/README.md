# Workshop Scenarios (planning doc, internal)

Not attendee-facing. Source material for later modeling into the Workshop
tab UI. Each scenario gets its own folder once fleshed out.
...
Rest TBD -- add folders as each scenario gets built out.
